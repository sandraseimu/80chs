...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View view = ltInflater.inflate(R.layout.content_main, null, false);
        Button SAmerica = (Button) findViewById(R.id.btn_samerica);
        ...
        Button NAmerica = (Button) findViewById(R.id.btn_namerica);
        ...
        Button Asia = (Button) findViewById(R.id.btn_asia);
